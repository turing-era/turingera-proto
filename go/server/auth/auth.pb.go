...
var file_auth_proto_goTypes = []interface{}{
	...
	(*EarlyAccess)(nil), // 3: turingera.server.auth.EarlyAccess
	(*LoginReq)(nil),    // 4: turingera.server.auth.LoginReq
	(*LoginRsp)(nil),    // 5: turingera.server.auth.LoginRsp
}
var file_auth_proto_depIdxs = []int32{
	1, // 0: turingera.server.auth.Auth.Nonce:input_type -> turingera.server.auth.NonceReq
	4, // 1: turingera.server.auth.Auth.Login:input_type -> turingera.server.auth.LoginReq
	2, // 2: turingera.server.auth.Auth.Nonce:output_type -> turingera.server.auth.NonceRsp
	5, // 3: turingera.server.auth.Auth.Login:output_type -> turingera.server.auth.LoginRsp
