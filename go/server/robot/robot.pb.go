...
type UpdateUseKnowledgeReq struct {
	...
	RobotId    string `protobuf:"bytes,1,opt,name=robot_id,json=robotId,proto3" json:"robot_id,omitempty"`
	UseEcho    bool   `protobuf:"varint,2,opt,name=use_echo,json=useEcho,proto3" json:"use_echo,omitempty"`
	UseAboutMe bool   `protobuf:"varint,3,opt,name=use_about_me,json=useAboutMe,proto3" json:"use_about_me,omitempty"`
}
...
func (x *UpdateUseKnowledgeReq) GetUseEcho() bool {
	if x != nil {
		return x.UseEcho
	}
	return false
...
func (x *UpdateUseKnowledgeReq) GetUseAboutMe() bool {
	if x != nil {
		return x.UseAboutMe
	}
	return false
...
var file_robot_proto_rawDesc = []byte{
	...
	0x22, 0x6f, 0x0a, 0x15, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x4b, 0x6e, 0x6f,
	...
	0x6f, 0x74, 0x49, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x5f, 0x65, 0x63, 0x68, 0x6f,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x75, 0x73, 0x65, 0x45, 0x63, 0x68, 0x6f, 0x12,
	0x20, 0x0a, 0x0c, 0x75, 0x73, 0x65, 0x5f, 0x61, 0x62, 0x6f, 0x75, 0x74, 0x5f, 0x6d, 0x65, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x75, 0x73, 0x65, 0x41, 0x62, 0x6f, 0x75, 0x74, 0x4d,
