...
func request_RobotSvr_GetEditOptions_0(ctx context.Context, marshaler runtime.Marshaler, client RobotSvrClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetEditOptionsReq
	...
	msg, err := client.GetEditOptions(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_RobotSvr_GetEditOptions_0(ctx context.Context, marshaler runtime.Marshaler, server RobotSvrServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetEditOptionsReq
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetEditOptions(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterRobotSvrHandlerServer(ctx context.Context, mux *runtime.ServeMux, server RobotSvrServer) error {
	...
	mux.Handle("POST", pattern_RobotSvr_GetEditOptions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/turingera.server.robot.RobotSvr/GetEditOptions", runtime.WithHTTPPathPattern("/robot/GetEditOptions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_RobotSvr_GetEditOptions_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_RobotSvr_GetEditOptions_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterRobotSvrHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RobotSvrClient) error {
	...
	mux.Handle("POST", pattern_RobotSvr_GetEditOptions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/turingera.server.robot.RobotSvr/GetEditOptions", runtime.WithHTTPPathPattern("/robot/GetEditOptions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_RobotSvr_GetEditOptions_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_RobotSvr_GetEditOptions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"robot", "GetEditOptions"}, ""))
...
var (
	forward_RobotSvr_GetEditOptions_0 = runtime.ForwardResponseMessage
