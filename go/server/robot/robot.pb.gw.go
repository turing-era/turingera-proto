...
func request_RobotSvr_GetRobots_0(ctx context.Context, marshaler runtime.Marshaler, client RobotSvrClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetRobotsReq
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GetRobots(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_RobotSvr_GetRobots_0(ctx context.Context, marshaler runtime.Marshaler, server RobotSvrServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetRobotsReq
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetRobots(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterRobotSvrHandlerServer(ctx context.Context, mux *runtime.ServeMux, server RobotSvrServer) error {
	...
	mux.Handle("POST", pattern_RobotSvr_GetRobots_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_RobotSvr_GetRobots_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_RobotSvr_GetRobots_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterRobotSvrHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RobotSvrClient) error {
	...
	mux.Handle("POST", pattern_RobotSvr_GetRobots_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_RobotSvr_GetRobots_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_RobotSvr_GetRobots_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"robot", "GetRobots"}, ""))
...
var (
	...
	forward_RobotSvr_GetRobots_0 = runtime.ForwardResponseMessage
